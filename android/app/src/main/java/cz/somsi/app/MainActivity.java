...
public class MainActivity extends Activity {
    ...
    /**
     * The home screen is deliberately rendered from the approved reference artwork.
     * No automatic redesign, reflow or alternative visual treatment is applied.
     * Transparent hotspots provide the functionality without changing the approved design.
     */
    ...
    private void addHomeHotspots() {
        ...
        // Main 3x3 section grid — coordinates are tied to the approved artwork.
        ...
        // Consultation / direct phone area
        hotspot(4, 1068, 751, 115, this::callPhone);

        // Bottom navigation
        hotspot(0, 1358, 150, 153, this::showHome);
    ...
    private void showMenu() {
        ...
        new AlertDialog.Builder(this)
                .setTitle("SOMSI stavební práce")
                .setItems(items, (d, which) -> {
                    switch (which) {
                        case 0: openWeb(); break;
                        case 1: callPhone(); break;
                        case 2: showChat(); break;
                        case 3: openCamera(); break;
                        case 4: openSection("Zakázky"); break;
                        case 5: openSection("Adresář"); break;
                        default: showAbout();
                    }
                })
    ...
    private void callPhone() {
        try {
            ...
            Toast.makeText(this, "Telefon není dostupný", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void openWeb() {
        try {
            ...
            Toast.makeText(this, "Web nelze otevřít", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void openSection(String title) {
        ...
        page.setPadding(22, 22, 22, 22);

        LinearLayout header = new LinearLayout(this);
        header.setGravity(Gravity.CENTER_VERTICAL);
        TextView back = text("‹", 38, GOLD, true);
        back.setGravity(Gravity.CENTER);
        back.setOnClickListener(v -> showHome());
        header.addView(back, new LinearLayout.LayoutParams(58, 62));
        header.addView(text(title, 24, Color.WHITE, true), new LinearLayout.LayoutParams(0, 62, 1));
        page.addView(header);
    ...
    private void showChat() {
        ...
        back.setOnClickListener(v -> showHome());
        header.addView(back, new LinearLayout.LayoutParams(58, 62));
        header.addView(text("Chat SOMSI", 24, Color.WHITE, true), new LinearLayout.LayoutParams(0, 62, 1));
        page.addView(header);

        TextView messages = text("Petr • 09:12\nZakázka Třemošnice – práce pokračují podle plánu.\n\nVy • 09:18\nDěkuji, potvrzuji.\n\nJana • 09:26\nNové fotografie jsou nahrané.", 16, Color.WHITE, false);
        messages.setBackgroundColor(PANEL);
        messages.setPadding(18, 18, 18, 18);
        page.addView(messages, new LinearLayout.LayoutParams(-1, 0, 1));

        LinearLayout compose = new LinearLayout(this);
        EditText input = new EditText(this);
        input.setHint("Napište zprávu…");
        input.setTextColor(Color.WHITE);
        input.setHintTextColor(Color.GRAY);
        compose.addView(input, new LinearLayout.LayoutParams(0, 60, 1));
        Button send = new Button(this);
        send.setText("Odeslat");
        send.setTextColor(Color.BLACK);
        send.setBackgroundColor(GOLD);
        ...
        compose.addView(send, new LinearLayout.LayoutParams(110, 60));
    ...
    private void newRecord() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(items, (d, which) -> {
                    if (which == 1) openCamera();
                    else Toast.makeText(this, items[which] + " – připraveno", Toast.LENGTH_SHORT).show();
                })
